...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO dokter (id, nama, gender, tmp_lahir, tgl_lahir, kategori, telpon, alamat, unit_kerja_id) VALUES (?,? ,? ,? ,? ,? ,? ,?, ?)";
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                    <input id="unit_kerja_id" name="unit_kerja_id" type="number" class="form-control">
                                </div>
                                </div>
                                <div class="form-group row">
