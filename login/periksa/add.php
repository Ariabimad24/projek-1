                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="Pasien id" class="col-4 col-form-label">Pasien ID</label>
                                    <div class="col-8">
                                        <input id="pasien id" name="pasien id" type="number" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="dokter id" class="col-4 col-form-label">Dokter ID</label>
                                    <div class="col-8">
                                        <input id="pasien id" name="dokter id" type="number" class="form-control">
                                    </div>
</div>
                                <div class="form-group row">
